...
export interface components {
  schemas: {
    ...
    BoolFieldValue:
      ...
      & (
        & Omit<
          WithRequired<components["schemas"]["AbstractFieldValue"], "type">,
          "type"
        >
        & {
    ...
    ChoiceDocuments:
      & Omit<components["schemas"]["BaseTrackerFieldChoiceOption"], "type">
      & {
        referenceFilters?:
          components["schemas"]["ReferenceFilterBasedChoice.ReferenceFilter"][];
      }
      & {
        /**
    ...
    ExportForDeploymentRequest: {
      ...
      projectSettings?:
        components["schemas"]["DeploymentProjectExportSettings"][];
    ...
    PerStatusFieldPermission:
      & Omit<components["schemas"]["BaseTrackerFieldPermission"], "type">
      & {
        accessPermissionsPerStatusMap?: {
          [key: string]:
            components["schemas"]["TrackerFieldPermission.AccessPermission"][];
        };
      }
      & {
        /**
    ...
    RoleWithPermissions: {
      ...
      trackerPermissions?:
        components["schemas"]["TrackerPermissionReference"][];
    };
    ...
    Tracker: {
      ...
      trackerFieldLayoutSettingsModel?:
        components["schemas"]["TrackerFieldLayoutSettings"];
    ...
    TrackerField: {
      ...
      choiceOptionSetting?:
        components["schemas"]["BaseTrackerFieldChoiceOption"];
      computedAs?: string;
      computedFieldReferences?:
        components["schemas"]["TrackerField.ComputedFieldReference"][];
      dateFieldSettings?:
        components["schemas"]["TrackerField.DateFieldSettings"];
    ...
    TrackerFieldPermissions: {
      ...
      fieldPermissions?:
        components["schemas"]["TrackerFieldStatusPermissions"][];
    ...
    TrackerItemFieldMappingInfo: {
      ...
      possibleMapping?:
        components["schemas"]["TrackerItemFieldMappingPossiblePair"][];
    };
    ...
    TrackerItemRelationsResult: {
      ...
      downstreamReferences?:
        components["schemas"]["DownstreamTrackerItemReference"][];
      /** @description References and associations to the item */
      incomingAssociations?:
        components["schemas"]["IncomingTrackerItemAssociation"][];
      ...
      outgoingAssociations?:
        components["schemas"]["OutgoingTrackerItemAssociation"][];
      /**
       * Format: int32
       * @description Page no.
       */
      ...
      /** @description References and associations to the item */
      upstreamReferences?:
        components["schemas"]["UpstreamTrackerItemReference"][];
    };
    ...
    TrackerReportSettings: {
      ...
      referenceLevelSettings?:
        components["schemas"]["ReportReferenceLevelSettings"][];
      /**
...
export interface operations {
  getMasterSyncTime: {
    ...
    responses: {
      ...
      500: {
        ...
        content: {
          "application/json":
            components["schemas"]["InternalServerErrorException"];
        };
      };
    };
  };
  ...
  getAssociationHistory: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["ArtifactRevisionSearchResult"];
        };
      };
      /** @description Bad Request */
      400: {
  ...
  batchGetTrackerItemReviews: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["BatchGetTrackerItemReviewsRequest"];
      };
    };
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["TrackerItemWithTrackerItemReviewsExport"][];
        };
      };
  ...
  getTrackerItemsAttachmentContents: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["TrackerItemAttachmentRequest"];
      };
    };
    responses: {
  ...
  bulkUpdateTrackerItemFields: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["UpdateTrackerItemFieldWithItemId"][];
      };
    };
    responses: {
  ...
  getItemMoveFieldMapping: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["TrackerItemFieldMappingInfo"];
        };
      };
      /** @description Bad Request */
      400: {
  ...
  getBaselineTrackerItemsRelations: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["TrackerItemRelationsResult"][];
        };
      };
      /** @description Authentication is required */
      403: {
  ...
  replaceChildrenOfTrackerItem: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["UpdateTrackerItemChildrenRequest"];
      };
    };
    responses: {
  ...
  addChildToTrackerItem: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["TrackerItemChildReference"];
        };
      };
      /** @description Invalid request */
      400: {
  ...
  getItemAccessibility: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["TrackerItemFieldAccessibilityList"];
        };
      };
      /** @description Authentication is required */
      401: {
  ...
  updateTableFieldTrackerItem: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["UpdateTrackerItemTableField"];
      };
    };
    responses: {
      /** @description Basic tracker item by id */
  ...
  updateWorkingSetWithTransientFields: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["WorkingSetUpdateWithTransientFieldsRequest"];
      };
    };
    responses: {
      /** @description Job has been scheduled successfully */
  ...
  getMembersOfProject: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["MemberReferenceSearchResult"];
        };
      };
      /** @description Bad Request */
      400: {
  ...
  getAuditPermissions: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["PaginatedAuditPermissionsResponse"];
        };
      };
      /** @description Bad Request */
      400: {
      ...
      422: {
        ...
        content: {
          "application/json":
            components["schemas"]["InvalidParametersException"];
        };
      };
      /** @description Too many requests */
      429: {
  ...
  getTraceabilityInitialItemIds: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["TraceabilityInitialLevelFilter"];
      };
    };
    responses: {
      /** @description Tracker item list */
  ...
  createExternalScmRepository: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["ExternalScmRepositoryRequest"];
      };
    };
    responses: {
  ...
  createTestRunForTestSets: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["CreateTestRunFromTestSetsRequest"];
      };
    };
    responses: {
      /** @description The newly created test run */
  ...
  getTrackerFieldsPermissions: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["TrackerFieldsStatusPermissions"];
        };
      };
  ...
  getUsers: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json":
            components["schemas"]["UserReferenceSearchResult"];
        };
      };
      /** @description Bad Request */
      400: {
  ...
  getItemsMappingInWorkingSet: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["WorkingSetItemsMappingRequest"];
      };
    };
    responses: {
  ...
  updateWorkingSetPermission: {
    ...
    requestBody: {
      content: {
        "application/json":
          components["schemas"]["WorkingSetPermissionRequest"];
      };
    };
    responses: {
